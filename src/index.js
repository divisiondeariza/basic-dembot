...
class PianoRoll extends React.Component {
  ...
  render() {
    return (
        <Sketch setup={(p5, canvasParentRef) => setup(p5, canvasParentRef)} draw={(p5) => draw(p5, this.props.sample)} />
   )
  }
}


class PianoCanvas extends React.Component {
  render(){
      return (
          <Sketch setup={(p5, canvasParentRef) => setup(p5, canvasParentRef)} draw={(p5) => draw(p5, this.props.sample)} />
     )
